...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="../images/logo.jpg" alt=" Logo"  width="200" height="111" class="" style="opacity: .8">
                      ...
                      <tr class="gradeX">
                        <td height="104">
                            <div align="center"><?php echo $row['fullname']; ?> </div>
					              ...
					              <td>
                        <div align="center"><span class="controls"><img src="../<?php echo $row['photo'];?>"  width="91" height="73" border="2"/></span></div>
                        </td>
                        <td>
                            <div align="center"><?php echo $row['matric_no']; ?></div></td>
                        <td>
